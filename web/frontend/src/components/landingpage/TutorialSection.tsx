      ...
      <div className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          {activeStep === 0 && (
            ...
            >
              <div className="mb-16 flex flex-col items-center text-center">
                <h2 className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-rose-500">The problem</h2>
                <h1 className="text-4xl font-extrabold leading-tight tracking-tight text-slate-900 md:text-6xl">
                  Your data no longer speaks the same language.
                </h1>
                <p className="mt-6 max-w-2xl text-xl leading-relaxed text-slate-600">
                  Moving data between mismatched files and production systems has become
                  a manual, unpredictable bottleneck.
                </p>
              </div>
              ...
              <div className="flex w-full max-w-5xl flex-col items-center gap-12 md:flex-row">
                <div className="w-full flex-1 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <span className="font-mono text-xs font-semibold text-slate-500">BROKEN_IMPORT.CSV</span>
                  </div>
              ...
              <div className="mt-16 flex gap-8 text-slate-500">
                <div className="flex items-center gap-2">
                  <Trash2 size={16} />
                  <span className="text-sm">Manual time loss</span>
                </div>
                <div className="flex items-center gap-2">
                  <Code2 size={16} />
                  <span className="text-sm">Fragile conversion scripts</span>
                </div>
              </div>
            </motion.div>
          )}
          ...
          {activeStep === 1 && (
            ...
            >
              <div className="mb-14 flex flex-col items-center text-center">
                <h2 className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-purple-600">The solution</h2>
                <h1 className="text-4xl font-extrabold leading-tight tracking-tight text-slate-900 md:text-6xl">
                  One language to bring everything back in line.
                </h1>
                <p className="mt-6 max-w-3xl text-xl leading-relaxed text-slate-600">
                  Convertly transforms the source file with a readable script, applies your business rules,
                  and generates clean output for production tools.
                </p>
              </div>
          ...
          {activeStep === 2 && (
            ...
            >
              <h2 className="mb-4 text-center text-3xl font-bold text-slate-900 md:text-5xl">Try it yourself</h2>
              <p className="mb-8 max-w-2xl text-center text-slate-600">
                Import your data, apply your business rules, and convert on the fly. Test the interactive editor below.
              </p>
              ...
              <div className="flex h-[480px] w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-purple-200 bg-white shadow-lg shadow-purple-900/5 sm:h-[520px]">
                <div className="flex shrink-0 items-center justify-between gap-3 border-b border-slate-200 bg-purple-50 px-5 py-4">
                  <div className="flex items-center gap-3">
                    <Terminal className="text-purple-600" size={20} />
                    <span className="font-mono text-xs font-semibold text-purple-700">convertly.script - editor</span>
                  </div>
                  <span className="rounded-full bg-white px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-purple-600">
                    Live
                  </span>
                  ...
                  <div className="flex min-h-0 flex-col">
                    <div className="flex shrink-0 items-center justify-between gap-2 border-b border-slate-100 bg-slate-50 px-4 py-2.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-[11px] font-semibold text-slate-500">input.csv</span>
                      </div>
                      <button
                    ...
                    <textarea
                      ...
                      placeholder="Paste or type your source file here..."
                      spellCheck={false}
                    />
                  </div>
                  ...
                  <div className="relative flex min-h-0 flex-col">
                    <div className="flex shrink-0 items-center justify-between gap-2 border-b border-slate-100 bg-emerald-50 px-4 py-2.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-[11px] font-semibold text-emerald-700">result.json</span>
                      </div>
                      <button
                    ...
                    <pre className="flex-1 overflow-auto whitespace-pre-wrap bg-emerald-50/40 p-4 font-mono text-xs leading-relaxed text-emerald-800">
                      {outputText || <span className="italic text-slate-400">// The conversion result will appear here</span>}
                    </pre>
                    ...
                    <AnimatePresence>
                      {isProcessing && (
                        ...
                        >
                          ...
                          <span className="text-sm font-semibold tracking-wide text-purple-700">Running script (Rust)...</span>
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </div>
